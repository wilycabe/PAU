...
namespace CapaLogica.Clases
{
    ...
    internal class Persona
    {
        ...
        protected static bool VerificarCedula(string cedula)
        {
            ...
            return Clases.Cedula.VerificaIdentificacion(cedula);
        }
        ...
        protected static bool VerificarFechaNacimieto(string fecha)
        {
            try
            {
                ...
                return DateTime.Parse(fecha) <= System.DateTime.Today;
            }
            catch
            {
                return false;
        ...
        protected static bool VerificarMayoriaEdad(string fecha)
        {
            ...
            var fechaActual = System.DateTime.Today; // Toma la fecha del dia de actual
